...
public class ZipMakerFactoryTest {
    ...
    // This case tests that WordSequencePageZipMaker properly generates a zip file with all pages from all volumes concatenated into a single "bag of words" text file
    @Test
